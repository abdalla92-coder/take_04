...
<head>
    ...
    <!-- Use CDN for Bootstrap CSS (reliable for local files) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">

    <!-- Optional: Custom styles (inline for simplicity; move to sign-in.css if needed) -->
    <style>
        .bd-placeholder-img {
            font-size: 1.125rem;
            text-anchor: middle;
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action ="{{ route('postdata') }}" method="post">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit">send data</button>
    ...
    <!-- Optional: Color modes script (CDN or inline) -->
    <script>
        // Simple color mode toggle (from Bootstrap docs)
