...
<div class="page-content">
    <section class="row">
                  ...
                  <div class="card-body">
    <div class="border rounded p-4 bg-light d-flex align-items-center justify-content-center" style="height: 150px;">
        <div class="display-6 fw-bold text-center">jadara IT College</div>
    </div>
</div>
</div>
</div>
